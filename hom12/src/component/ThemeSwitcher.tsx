/*
 * The ThemeSwitcher component manages the theme state (light or dark) and 
 * passes it along with the toggleTheme function to the render prop.
 */

import { FC, useState } from "react"
import { ThemeSwitcherProps } from "../api/types";

export const ThemeSwitcher: FC<ThemeSwitcherProps> = ({ render }) => {
