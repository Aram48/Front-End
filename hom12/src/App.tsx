...
/*
 * This is the main App component, which renders the ThemeSwitcher.
 * ThemeSwitcher allows switching between light and dark themes.
 */
const App: React.FC = () => {
  return (
    <ThemeSwitcher
      /*
       * The render function inside ThemeSwitcher decides how the UI should look
